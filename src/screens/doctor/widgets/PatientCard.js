...
const SchedulesBox = styled.View`
  ...
  width: 100px;
  border-radius: 5px;
  background-color: ${({ actionCard = "agendada" }) =>
    actionCard == "agendada" ? AppColors.lightGreen : AppColors.whiteGray};
`;
            ...
            <Column justifyContent={Flex.spaceBetween}>
              <Column width={"90%"}>
                ...
                <Row justifyContent={Flex.flexStart} alignItems={Flex.center}>
                  <TextRegular size={14}>
                    {age} {t(AppLocalizations.yearsOld)}
                  </TextRegular>
                  <Spacing width={7} />
                  <TextSemiBold color={AppColors.grayV6}>•</TextSemiBold>
                  <Spacing width={7} />
                  <TextSemiBold color={AppColors.grayV4} size={14}>
                    {examType}
                  </TextSemiBold>
                </Row>
              </Column>
